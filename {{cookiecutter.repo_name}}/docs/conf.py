...
SUMMARY = {{ cookiecutter.repo_name }}.__description__
SHORT_COPYRIGHT = u'{{ cookiecutter.year }}, {0}. Some Rights Reserved.'.format(AUTHORS)
COPYRIGHT = u'''{0}
...
version = re.match(r'\d+\.\d+', {{ cookiecutter.repo_name }}.__version__).group(0)
...
#  [howto/manual]).
latex_documents = [
    ('index', '{{ cookiecutter.project_name }}.tex', LONG_TITLE, AUTHORS, 'manual'),
]
...
texinfo_documents = [
    ('index', '{{ cookiecutter.project_name }}', LONG_TITLE, AUTHORS,
     '{{ cookiecutter.project_name }}', SUMMARY, 'Miscellaneous'),
]
